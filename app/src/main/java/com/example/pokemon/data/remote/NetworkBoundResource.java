...
public abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    /* Based on implementation, should return true if it is needed to fetch data from server */
    @MainThread
    ...
    /* Responsible for creating a remote server call which fetches data from server*/
    @NonNull
    @MainThread
